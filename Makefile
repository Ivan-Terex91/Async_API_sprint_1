...
# Create es indexes
.PHONY: es-create-indexes, es-create-movies-index, es-create-genres-index
es-create-indexes: es-create-movies-index es-create-genres-index
...
# Delete es indexes
.PHONY: es-delete-indexes, es-delete-movies-index, es-delete-genres-index
es-delete-indexes: es-delete-movies-index es-create-genres-index

es-delete-movies-index:
	curl -XDELETE localhost:9200/movies

es-delete-genre-index:
